...
import logoOfApp from './../../assets/images/circuitLogo.png';
                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-11-5 ml-[5px] flex-none" src={logoOfApp} alt="logo" />
                            ...
                            <li className="menu nav-item">
                                <NavLink to="https://vristo.sbthemes.com" target="_blank" className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">User</span>
                                    </div>
                                </NavLink>
                            </li>
                            <li className="menu nav-item">
                                ...
                                {settingsOpen && (
                                    <ul className="sub-menu py-2 space-y-1 list-none">
                                        <li>
                                            <NavLink to="/settings/menu1" className="block px-2 py-1 hover:text-primary nav-link">
                                                Master page 1
                                            </NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/settings/menu2" className="block px-2 py-1 hover:text-primary nav-link">
                                                Master page 2
                                            </NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/settings/menu3" className="block px-2 py-1 hover:text-primary nav-link">
                                                Master page 3
                                            </NavLink>
                                        </li>
                                    </ul>
